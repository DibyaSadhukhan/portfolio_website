        ...
        <nav className="fixed top-0 left-0 w-full z-50 bg-[#080806]/90 backdrop-blur-md border-b border-gray-800/60 transition-all">
            <div className="max-w-6xl mx-auto px-6 h-20 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium">
                    <Link href="/" className={`flex items-center gap-2 transition ${activeSection === 'home' ? 'text-white font-bold' : 'text-gray-400 hover:text-white'}`}>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden absolute top-20 left-0 w-full bg-[#080806]/95 backdrop-blur-3xl border-b border-gray-800/80 p-6 flex flex-col gap-6 shadow-[0_20px_40px_rgba(0,0,0,0.8)]">
                    <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className={`flex items-center gap-4 text-lg transition ${activeSection === 'home' ? 'text-white font-bold' : 'text-gray-400'}`}>
