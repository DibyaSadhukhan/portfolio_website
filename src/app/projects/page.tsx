...
export default function ProjectsPage() {
    ...
    return (
        <main className="min-h-screen bg-[#080806] pt-32 pb-24 px-6 text-gray-300 overflow-x-hidden">
            <div className="max-w-6xl mx-auto">

                {/* Fetch styling Header */}
                <div className="text-center mb-16 relative w-full overflow-hidden">
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mb-6 font-mono tracking-tight cursor-default break-words">
                    ...
                    {projects_data.map(p => (
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-wrap gap-x-6 gap-y-4 pt-5 border-t border-gray-800 items-center pointer-events-auto">
                                ...
                                {p.github !== "NDA" && p.github !== "no_code" && p.github !== "#" && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-x-6 gap-y-4 pt-6 border-t border-gray-800 items-center">
                            ...
                            {project.github !== "NDA" && project.github !== "no_code" && project.github !== "#" && (
